            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#myPage">Add Teacher</a></li>
                </ul>
              </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8 login-box">
                ...
                <div class="col-lg-12 login-form">
                    <div class="col-lg-12 login-form">
                      <form action="../includes/teacherRegister.inc.php" method="POST">
                      ...
                      <?php
                            ...
                            <div class="col-lg-6 login-btm login-button">
                              <button type="submit" name="teacher-register-submit" class="btn btn-primary dark-btn">Register Techer</button>
                            </div>
                        </form>
                    </div>
                </div>
