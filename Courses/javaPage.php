  ...
  <div id="wrapper">
    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-nav">
        <li  class="active"><a href="#MENU"></i>MENU</a></li>
        <li><a href="../Quizes/exp1Quiz.php">QUIZ</a></li>
        <li><a href="../Online-Compiler-Windows-Server-master/javaConsole.php"></i>CONSOLE</a></li>
      </ul>
    </aside>
            ...
            <div class="col-xs-10">
              <div class="card">
                <div class="card-block">
                  ...
                  <a href="exp1.php" class="btn btn-primary">
              ...
              <div class="card">
                <div class="card-block">
                  <h4 class="card-title">Experiment-3
                    <a href="exp3.php" class="btn btn-primary">
                      <span class="glyphicon glyphicon-arrow-right"></span>
                    </a>
                  </h4>
                  <hr class="style1">
